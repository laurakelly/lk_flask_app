function bubbleChart() {
    ...
    d3.json("static/resume/data.json", function(error, root) {
...
function tooltip (d, id) {
    $(id).append(tooltipText(d));
    $(id + " .tooltip[data-title='" + d.title + "']").css(tooltipLoc(d, id));
}
...
/* 
 * function to create click event for d3 elements
 * jQuery's usual .click() doesn't work with d3 elements
 * http://stackoverflow.com/a/11180172/1880100 
 */
...
$(document).ready(function () {
    ...
    // Expand WebAction by default
    $("#experience [data-title='WebAction'].dot").d3Click();
